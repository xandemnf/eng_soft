...
<div id="ofertas_pag_ini" class="col-md-12"> 
	...
	<div class="col-md-4">
		...
		<form method="post" action="reservar_remover.php">
			<div>
				<button id="reserva_rio" name="reserva_rio" type="submit" class="btn btn-default btnSearch">Reservar
					<span class="glyphicon glyphicon"> </span>
				</button>
				<button id="reserva_rio_off" name="reserva_rio_off" type="submit" class="btn btn-default btnSearch" style="margin-left: 10px">Remover Reserva
					<span class="glyphicon glyphicon"> </span>
				</button>
		</div>
	</form>
	...
	<div class="col-md-4">
		...
		<form method="post" action="reservar_remover.php">
			<div>
				<button id="reserva_arraial" name="reserva_arraial" type="submit" class="btn btn-default btnSearch">Reservar
					<span class="glyphicon glyphicon"> </span>
				</button>
				<button id="reserva_arraial_off" name="reserva_arraial_off" type="submit" class="btn btn-default btnSearch" style="margin-left: 10px">Remover Reserva
					<span class="glyphicon glyphicon"> </span>
				</button>
			</div>
		</form>
	...
	<div class="col-md-4">
		...
		<form method="post" action="reservar_remover.php">
			<div>
				<button id="reserva_gramado" name="reserva_gramado" type="submit" class="btn btn-default btnSearch">Reservar
					<span class="glyphicon glyphicon"> </span>
				</button>
				<button id="reserva_gramado_off" name="reserva_gramado_off" type="submit" class="btn btn-default btnSearch" style="margin-left: 10px">Remover Reserva
					<span class="glyphicon glyphicon"> </span>
				</button>
			</div>
		</form>	
